...
from utils.general import (LOGGER, check_amp, check_dataset, check_file, check_git_status, check_img_size,
                           ...
                           print_args, print_mutation, strip_optimizer, yaml_save)  # set_seeds
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'weights/yolov7-seg.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='/root/seg/models/segment/yolov7-seg.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/gasplume.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--project', default=ROOT / '/root/autodl-tmp/detail', help='save to project/name')
