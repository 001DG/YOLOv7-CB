...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/root/seg/runs/train-seg/exp/weights/best.pt', help='model path(s)')
    ...
    parser.add_argument('--save-json', action='store_true', default=False, help='save a COCO-JSON results file')  #获取S M L 
